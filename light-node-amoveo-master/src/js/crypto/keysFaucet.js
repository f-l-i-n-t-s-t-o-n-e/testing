...
//    div.appendChild(br());
    ...
    bal_div.innerHTML = "Balance loading...";
    ...
    */
    ...
    function update_pubkey() {
        ...
        link.href = "../explorers/account_explorer.html?pubkey="
            .concat(pub);
        link.innerHTML = pub.slice(0,6)+'...'+pub.slice(pub.length - 3, pub.length);
        link.target = "_blank";
        pub_div.innerHTML = ("Your address: ");
        pub_div.appendChild(link);
        pub_div.appendChild(space);
        var copyButton = button_maker2("Copy", copyToClipboard);
        pub_div.appendChild(copyButton);
        var saveButton = button_maker2("Download private key", save_keys);
        pub_div.appendChild(space2);
        pub_div.appendChild(saveButton);
    }
    update_pubkey();
