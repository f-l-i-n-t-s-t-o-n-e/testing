...
var amount_to_match_input;
//    div.appendChild(accept_button);
//    div.appendChild(br());

    async function view(offer1){
        console.log(offer1);
        var X = offer1;
...
//        accept_button.onclick = function(){
            var amount_to_match = Math.round(parseFloat(amount_to_match_input, 10) * token_units());
            if(!amount_to_match){
...
//        };
    ...
    function update_display(Y, now, contract1, contract2, available_to_match, original_limit_order_size){
        ...
        amount_to_match_input = A1.toString();
        var warning = "";
...
var swap_viewer3 = swap_viewer_creator3();
