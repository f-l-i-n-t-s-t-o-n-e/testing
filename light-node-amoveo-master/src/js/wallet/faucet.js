...
//    div.appendChild(title);
    ...
    details.innerHTML = "Sell a small amount of ETH for VEO";
 ...
 //   div.appendChild(display);
    ...
    var getStarted = button_maker2("Get started", placeholder);
    div.appendChild(getStarted);
    div.appendChild(br());
...
//    div.appendChild(more_button);
 ...
 //   div.appendChild(advanced_div);
    ...
    //test values
    var other_blockchain_input = text("");
    other_blockchain_input.value = "Bitcoin";
    var ticker_input = text("");
    ticker_input.value = "BTC";
    var receive_amount_input = text("");
    receive_amount_input.value = "0.1";
    var spend_amount_input = text("");
