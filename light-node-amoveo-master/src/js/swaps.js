...
//            nonce: 0,
    ...
    function offer_99(offer){
        ...
        offer99.amount2 = Math.round((offer.amount2 * 0.9995) - (fee*5));//new oracle, oracle report, oracle close, withdraw winnings, oracle winnings
    ...
    function offer_01(offer){
        ...
        offer99.end_limit = offer.end_limit + 12000;
        offer99.amount1 = offer.amount2;
        offer99.amount2 = Math.round((offer.amount2 * 0.0005) - (fee*5));//new oracle, oracle report, oracle close, withdraw winnings, oracle winnings
