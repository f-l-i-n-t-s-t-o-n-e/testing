...
//            nonce: 0,
    ...
    function offer_99(offer){
        ...
        offer99.amount2 = Math.round((offer.amount2 * 0.9925));//new oracle, oracle report, oracle close, withdraw winnings, oracle winnings
    ...
    function offer_01(offer){
        var offer99 = {};
        offer99.start_limit = offer.start_limit;
        offer99.end_limit = offer.end_limit + 12000;
        offer99.amount1 = offer.amount2;

//        offer99.amount2 = Math.round((offer.amount2 * 0.0025) - (fee*5));//new oracle, oracle report, oracle close, withdraw winnings, oracle winnings
        offer99.amount2 = Math.round((offer.amount2 * 0.0025));//new oracle, oracle report, oracle close, withdraw winnings, oracle winnings


        offer99.cid1 = offer.cid1
        offer99.cid2 = ZERO;
        offer99.type2 = 0;
        offer99.acc1 = keys.pub();
        offer99.partial_match = true;
